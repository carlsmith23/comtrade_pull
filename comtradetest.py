...
while code < 101:
    ...
    results_df = comtradeapicall.getFinalData('fb6483764ea64e49a2d1f9364c33ea82',typeCode='C', freqCode='A', clCode='HS', period='{}' .format(year), reporterCode='156', cmdCode='{}' .format(code), flowCode='M', partnerCode=None, partner2Code=None, customsCode=None, motCode=None, format_output='JSON',aggregateBy=None, breakdownMode='classic', countOnly=None, includeDesc=True)

    results_df.to_csv('./data/{} Imports {}.csv' .format(year, code))
    tm.sleep(10)

    results_dfx = comtradeapicall.getFinalData('fb6483764ea64e49a2d1f9364c33ea82',typeCode='C', freqCode='A', clCode='HS', period='{}' .format(year), reporterCode='156', cmdCode='{}' .format(code), flowCode='X', partnerCode=None, partner2Code=None, customsCode=None, motCode=None, format_output='JSON',aggregateBy=None, breakdownMode='classic', countOnly=None, includeDesc=True)
